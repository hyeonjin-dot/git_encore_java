...
public class PersonManagerForCollection {

	public PersonManagerForCollection() {}
	
	public static void main(String[] args) {
		PersonManagerForCollection m = new PersonManagerForCollection();
...
//			new Person("유성미","990101-2111111","우리집", "02-452-0939"),
...
//		m.showPersons(persons);
	...
	public void showPersons(List<Map<String,String>> persons) {
		for (int i = 0; i < 10; i++) {
//			System.out.print("[이름]");
